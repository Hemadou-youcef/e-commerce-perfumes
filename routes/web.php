...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::patch('dashboard/shipping_agencies/shipping_fee/{shippingFee}', [App\Http\Controllers\ShippingFeeController::class, 'update'])->name('shipping_fee.updateTarif');
    });
