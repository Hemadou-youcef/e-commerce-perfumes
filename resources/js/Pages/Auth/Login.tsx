...
const Login = () => {
    ...
    return (
        <>
            <Head title={t('custom.login_page.title')} />
                            ...
                            <div className="grid gap-4 p-5 pb-0">
                                <div className="grid gap-2">
                                    <Label htmlFor="username">
                                        {t('custom.login_page.username')}
                                    </Label>
                                    <Input id="username" type="username" placeholder={t('custom.login_page.username')} className="w-full h-9 focus-visible:ring-transparent"
                                ...
                                <div className="flex ltl:justify-end">
                                    <Link href="/forgot-password" className="text-xs text-gray-600 font-bold hover:text-second">
                                        {t('custom.login_page.forgot_password')}
                                    </Link>
                                </div>
                                <div className="block mt-2">
                                    <label className="flex items-center gap-2">
                                        ...
                                        <Label htmlFor="remember" className="text-xs text-gray-600 cursor-pointer select-none">
                                            {t('custom.login_page.remember_me')}
                                        </Label>
                                    </label>
                                </div>
                                <Button className="w-full bg-forth hover:bg-prime-dark active:bg-second">
                                    {processing ? <AiOutlineLoading3Quarters className="h-5 w-5 animate-spin" /> : <p className="text-white">{t('custom.login_page.login')}</p>}
                                </Button>
                            </div>
                        ...
                        <div className="relative -mt-5">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                ...
                                <span className="bg-background px-2 text-muted-foreground">
                                    {t('custom.login_page.or_register_with')}
                                    {/* Ou s'inscrire avec */}
                                </span>
                            </div>
                        </div>
