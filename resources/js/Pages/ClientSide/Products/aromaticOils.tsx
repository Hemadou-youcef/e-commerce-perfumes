...
const Perfumes = ({ ...props }) => {
    ...
    return (
        <>
            <Head>
                <title>
                    {t("custom.layout.navbar.aromatic_oils") + " | " + t("custom.layout.navbar.title")}
                </title>
                <meta property="og:title" content={t("custom.layout.navbar.aromatic_oils") + " | " + t("custom.layout.navbar.title")} />
                ...
                <meta name="keywords" content={
                    currentLocale() === "fr"
                        ...
                        : "عطور زيتية, عطور, ساعات, اكسسوارات, عطور فاخرة, ساعات أنيقة, جودة, شغف, أناقة, أسلوب, روائح"
                } />
