        ...
        <>
            ...
            <div className="flex flex-row justify-start items-center px-5 pt-5 pb-2 gap-2">
                ...
                {editMode && <Link href={`/dashboard/categories/${props?.category?.id}`}>
                    <h2 className="text-xs md:text-lg text-gray-900 font-bold tracking-tight">
                ...
                {editMode && <h2 className="text-xs md:text-lg text-gray-900 font-medium tracking-tight">Modifier un Categorie</h2>}
                {!editMode && <h2 className="text-xs md:text-lg text-gray-600 font-medium tracking-tight">Ajouter un Categorie</h2>}
            </div>
            <div className="md:mx-10 p-0 m-2 border rounded-none md:rounded-md overflow-hidden bg-white">
                ...
                <form onSubmit={submit} className="w-full">
                    ...
                    <div className="p-5 flex flex-col gap-5">
                        <div className="flex flex-col gap-5 sm:text-sm">
                            <div className="grid gap-3">
                                ...
                                <Select onValueChange={(value) => setData("type", parseInt(value))} value={data.type.toString()}>
                                    <SelectTrigger className="w-full md:w-96 h-12">
                        ...
                        <div className="grid md:grid-cols-2 gap-3">
                            <div className="grid gap-3">
                                <Label htmlFor="name" className="text-sm md:text-base">Nom</Label>
                                <Input
                                    id="name"
                                    type="text"
                            ...
                            <div className="grid gap-3 font-arabic">
                                <Label htmlFor="name_ar" className="text-sm md:text-base">Nom Arabe</Label>
                                <Input
                                    id="name_ar"
                                    type="text"
                                    dir="rtl"
